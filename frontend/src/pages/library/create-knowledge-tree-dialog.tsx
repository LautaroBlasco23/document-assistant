  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6 flex flex-col gap-5">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">New Knowledge Tree</h2>
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="tree-title" className="text-sm font-medium text-gray-700">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="tree-description" className="text-sm font-medium text-gray-700">
