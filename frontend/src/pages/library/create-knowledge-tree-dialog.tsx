...
export function CreateKnowledgeTreeDialog({ open, onClose }: CreateKnowledgeTreeDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-surface dark:bg-surface-card backdrop-blur-sm rounded-xl shadow-xl w-full max-w-md mx-4 p-6 flex flex-col gap-5">
        <div>
          <h2 className="text-lg font-semibold text-text-primary">New Knowledge Tree</h2>
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="tree-description" className="text-sm font-medium text-text-secondary">
            ...
            <textarea
              ...
              className="w-full rounded-md border border-surface-200 dark:border-surface-200 bg-surface dark:bg-surface-100 px-3 py-2 text-sm text-text-secondary placeholder-gray-400 dark:placeholder-slate-500 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary resize-none"
            />
          </div>
