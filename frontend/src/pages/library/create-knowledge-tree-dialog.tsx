        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="w-full rounded-md border border-surface-200 dark:border-slate-600 bg-surface dark:bg-surface-100 px-3 py-2 text-sm text-gray-700 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary resize-none"
            />
          </div>
