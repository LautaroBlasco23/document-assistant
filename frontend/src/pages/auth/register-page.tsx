    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-100 dark:bg-surface font-ui">
      <div className="max-w-md w-full space-y-8 p-8 bg-surface dark:bg-surface-200 rounded-lg shadow">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-text-secondary">Display Name (optional)</label>
            <input
              type="text"
              value={displayName}
        ...
        <div className="text-center text-sm text-text-secondary">
          ...
          <Link to="/login" className="text-primary hover:underline font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg rounded">
            Sign in
          </Link>
        </div>
      </div>
